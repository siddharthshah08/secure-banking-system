...
@Controller
public class MerReportanIssueController {

	public MerReportanIssueController()
	{
	...
	// Rohit - this is the controller method for report an issue functionality for merchant
	
	@RequestMapping(value="/MerReportanIssue", method=RequestMethod.GET)
    public ModelAndView get(HttpSession sessionID) throws SQLException  
    {  
			return new ModelAndView("MerReportanIssue","message",true);
    }
	
	//@RequestMapping(value="/ExternalReportanIssue", method=RequestMethod.GET)
    //public ModelAndView getExtern(HttpSession sessionID) throws SQLException  
    //{  
	//		return new ModelAndView("ReportanIssue","message",true);
    //}
	
	@RequestMapping(value="/MerIssueReportedSuccessfully", method=RequestMethod.POST)
    public ModelAndView post(@RequestParam("merissueDesc") String description, HttpSession sessionID) throws SQLException  
    {  
		...
		return new ModelAndView("MerIssueReportedSuccessfully","message",true);
    }
