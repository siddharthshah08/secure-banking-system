...
<div style="position:absolute;left:400px; top:200px; width:500px; height:150px; z-index:0"><font face="Cambria" size="4px" color="#3276b1">Thank you. Your issue has been reported and will be addressed by the concern authority</font></div>
...
<div class="list-group" style="position:absolute;left:170px; top:200px; width:200px; height:150px">
 ...
 <a id = "adduserLink" href="addInternalUser.html" class="list-group-item">Add Internal User</a>
  ...
  <a id = "reportLink" href="ReportAnIssue.html" class="list-group-item active">Report an Issue</a>
