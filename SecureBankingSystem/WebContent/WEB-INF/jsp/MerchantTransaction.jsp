...
<div class="list-group" style="position:absolute;left:170px; top:200px; width:200px; height:150px">
  ...
  <a id = "claimamt" href="transferfunds.html" class="list-group-item">Claim Amount</a>
  <a id = "merviewtran" href="Transactionlist.html" class="list-group-item active">View Transaction</a>
