...
<div style="position:absolute;left:400px; top:200px; width:500px; height:150px; z-index:0"><font face="Cambria" size="4px" color="#3276b1">Amount claimed successfully. Thank you for banking with us.</font></div>
...
<div class="list-group" style="position:absolute;left:170px; top:200px; width:200px; height:150px">
  ...
  <a id = "claimamt" href="MerchantClaimAmount.html" class="list-group-item active">Claim Amount</a>
