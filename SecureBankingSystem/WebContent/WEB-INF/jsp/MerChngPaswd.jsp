...
<form name ="merchngpaswd" action="MerPswdUpdSuc.html" method="post" onsubmit="return checkTest();">

<input name="mercrntpaswd" type="password" class = "form-control" style="position:absolute;width:420px;left:450px;top:205px;z-index:2" placeholder = "Current Password">
<input name="mernewpaswd" type="password" class = "form-control" style="position:absolute;width:420px;left:450px;top:255px;z-index:2" placeholder = "New Password">
<input name="mernewpaswd1" type="password" class = "form-control" style="position:absolute;width:200px;left:450px;top:305px;z-index:2" placeholder = "Retype New Password">

<input name="update" type="submit" value="Update" style="position:absolute;width:200px;left:450px;top:355px;z-index:4;" class = "btn btn-primary"/>
<input name="Cancel" type="button" value="Cancel" style="position:absolute;width:200px;left:670px;top:355px;z-index:4;" class = "btn btn-primary"/>
