...
<div style="position:absolute;left:400px; top:200px; width:500px; height:150px; z-index:0"><font face="Cambria" size="4px" color="#3276b1">Profile updated successfully for the user --> ${modUser}</font></div>
